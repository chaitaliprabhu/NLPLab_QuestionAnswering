...
class Data:
    ...
    def __init__(self, seed=3, remove_unk=False):
        ...
        self.word_vocab = Dictionary.load_from_text(str(current_file)+"/Task4/data/word.vocab")
        self.entity_vocab = Dictionary.load_from_text(str(current_file)+"/Task4/data/entity.vocab")
        self.predicate_vocab = Dictionary.load_from_text(str(current_file)+"/Task4/data/predicate.vocab")

        # loading data files names
        self.datafile =str(current_file)+"/Task4/data/final/train_output.txt"
        self.data = {}
