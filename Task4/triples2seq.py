...
class Triple2SeqModel():
    ...
    def predict(self, sess, encoder_triples_inputs, encoder_predicates_direction):
        ...
        feed_dict = {
            self.encoder_entities_inputs: [[encoder_triples_inputs[0,0],encoder_triples_inputs[0,2]]],  # pick up subjects and objects
            self.encoder_predicates_inputs: [[encoder_triples_inputs[0,1]]],  # pick up predicates
            self.encoder_predicates_direction: encoder_predicates_direction
        }
        print (feed_dict)
        print(self.decoder_pred_inference)
